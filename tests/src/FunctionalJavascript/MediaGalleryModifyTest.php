...
JS;
  ...
  public function testAddRemove(): void {
    ...
    $fileNamePosition = $this->getSession()
      ->evaluateScript('jQuery(\'div.slick--initialized div.slick-slide:not(.slick-cloned):nth(1) img\').attr(\'src\').indexOf("26315068204_24ffa6cfc4_o.jpg")');
    ...
    $fileNamePosition = $this->getSession()
      ->evaluateScript('jQuery(\'div.slick--initialized div.slick-slide:not(.slick-cloned):nth(2) img\').attr(\'src\').indexOf("reference.jpg")');
