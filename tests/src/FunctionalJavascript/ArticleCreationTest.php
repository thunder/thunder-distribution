...
class ArticleCreationTest extends ThunderJavascriptTestBase {
  ...
  public function testCreateArticle(): void {
    ...
    $this->getSession()
      ->wait(5000, "jQuery('iframe').filter(function(){return (this.id.indexOf('instagram-embed-0') !== -1);}).length === 1");
    $numOfElements = $this->getSession()->evaluateScript("jQuery('iframe').filter(function(){return (this.id.indexOf('instagram-embed-0') !== -1);}).length");
