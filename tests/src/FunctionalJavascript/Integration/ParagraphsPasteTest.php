...
class ParagraphsPasteTest extends ThunderJavascriptTestBase {
  ...
  public function testMultilineTextPaste(): void {
    ...
    $this->assertEquals("22", $this->getSession()->getPage()->find('xpath', '//input[@name="field_paragraphs[1][subform][field_video][selection][0][target_id]"]')->getValue(), 'Video should be connected to the paragraph subform.');
