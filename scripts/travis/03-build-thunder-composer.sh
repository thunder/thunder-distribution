...
composer require "drush/drush:~9.0" "drupal/rules:3.x-dev" "drupal/feeds:3.x-dev" "drupal/facets:1.x-dev" "drupal/schema_metatag" "drupal/graphql" --no-update --no-progress ${ADDITIONAL_COMPOSER_PARAMETERS}
composer require "thunder/thunder-distribution:*" "thunder/thunder_testing_demo:3.x-dev" "phpunit/phpunit:^6.5" "composer/composer:^1.9.0" "mglaman/phpstan-drupal:~0.12.0" "phpstan/phpstan-deprecation-rules:~0.12.0" "drupal/nexx_integration:^3.0" "valiton/harbourmaster:~8.1" --no-progress ${ADDITIONAL_COMPOSER_PARAMETERS}
