...
composer require "thunder/thunder-distribution:*" "thunder/thunder_testing_demo:3.x-dev" "phpunit/phpunit:^6.5" "composer/composer:^1.9.0" "mglaman/phpstan-drupal:~0.12.0" "phpstan/phpstan-deprecation-rules:~0.12.0" "valiton/harbourmaster:~8.1" "drupal/rules:3.x-dev" --no-progress ${ADDITIONAL_COMPOSER_PARAMETERS}
