...
composer require "thunder/thunder-distribution:*" "phpunit/phpunit:^6.5" "symfony/browser-kit:^4.0.0" "mglaman/phpstan-drupal" "phpstan/phpstan:0.11.6" "phpstan/phpstan-deprecation-rules:0.11.1" "drupal/riddle_marketplace:^3.0-beta2" "drupal/nexx_integration:^1.0" "valiton/harbourmaster:~8.1" "drupal/select2:1.x-dev" --no-progress ${ADDITIONAL_COMPOSER_PARAMETERS}
