...
cd ${TEST_DIR}
composer require "drupal/liveblog:^1.0-alpha2" "drush/drush:^9.6.2" "cweagans/composer-patches:^1.6.6" "zaporylie/composer-drupal-optimizations:^1.1.0" --no-progress --no-update
