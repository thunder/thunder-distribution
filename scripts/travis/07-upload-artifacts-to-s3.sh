...
cd "${TEST_DIR}"
composer require "thunder/thunder_performance_measurement:dev-master" "thunder/testsite_builder:dev-feat/support-for-search-api-views" "drupal/media_entity_generic:^1.0" --no-interaction --update-no-dev
