...
composer require "thunder/thunder_testing_demo:3.x-dev" "behat/mink-selenium2-driver" "behat/mink-goutte-driver" "mikey179/vfsStream" "lullabot/amp" "pusher/pusher-php-server:^3.0.0" --no-progress --working-dir --no-update "${TEST_DIR}"/docroot
