...
COMPOSER_ROOT_VERSION=9.0.x-dev composer require "drupal/core-dev:^9.0.0" "thunder/thunder_testing_demo:3.x-dev" "pusher/pusher-php-server:^3.0.0" --no-progress --working-dir ${TEST_DIR}/docroot
