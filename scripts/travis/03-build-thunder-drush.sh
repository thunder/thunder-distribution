...
COMPOSER_ROOT_VERSION=8.9.x-dev composer require "drupal/core-dev" "thunder/thunder_testing_demo:3.x-dev" "lullabot/amp" "pusher/pusher-php-server:^3.0.0" --no-progress --working-dir ${TEST_DIR}/docroot
