...
install_thunder() {
    ...
    /usr/bin/env PHP_OPTIONS="-d sendmail_path=`which true`" drush si thunder -vvv --db-url=mysql://travis@127.0.0.1/drupal -y thunder_module_configure_form.install_modules_thunder_demo
