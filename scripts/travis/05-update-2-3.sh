...
mv composer.json composer1.json
cat composer1.json| jq '.extra.patches += {"drupal/media_entity":{"Update path to core media breaks default view- and form-display config":"https://www.drupal.org/files/issues/2019-06-17/2948704-7.patch"}}' > composer.json
